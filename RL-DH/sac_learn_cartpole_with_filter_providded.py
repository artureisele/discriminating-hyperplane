...
"""
    ...
    pret_dir = '/home/artur/Schreibtisch/DiscriminatingHyperplaneFork/discriminating-hyperplane/RL-DH/envs/LearnedModels/model_with_bonus.pt'
    filter_actor = torch.load(pret_dir)
